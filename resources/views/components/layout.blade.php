        ...
        <nav class="md:flex md:justify-between md:items-center">
            ...
            <div class="mt-8 md:mt-0 flex items-center">
                @auth
                    ...
                    <x-dropdown>
                        <x-slot name="trigger">
                            <button class="text-xs font-bold uppercase">Welcome, {{ auth()->user()->name }}</span>
                        </x-slot>
                        @can('admin')
        ...
        <footer id="newsletter" class="bg-gray-100 border border-black border-opacity-5 rounded-xl text-center py-16 px-10 mt-16">
            ...
            <div class="mt-10">
                <div class="relative inline-block mx-auto lg:bg-gray-200 rounded-full">
                    ...
                    <form class="lg:flex text-sm" method="POST" action="/newsletter">
                        @csrf
                        ...
                        <button
                            type="sutmit"
                            class="bg-blue-500 lg:ml-3 hover:bg-blue-600 mt-4 lg:mt-0 rounded-full text-xs font-semibold text-white uppercase py-3 px-8"
                        >Subscribe</button>
                    </form>
                </div>
            </div>
